...
function run(options) {
  ...
  if (os.platform().indexOf('linux') > -1) {
    cmd.executable = __dirname + '/../../../../nodejs/bin/node/linux/node';
  } else if (os.platform().indexOf('win') > -1) {
    cmd.executable = __dirname + '/../../../../nodejs/bin/node/windows/node';
  } else {
    cmd.executable = __dirname + '/../../../../nodejs/bin/node/mac/node';
  }
